                    ...
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">Branch 1<span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="roompage.php">Room 1</a>
                                        </li>
                                        <li>
                                            <a href="roompage.php">Room 2</a>
                                        </li>
                                        <li>
                                            <a href="roompage.php">Room 3</a>
                                        </li>
                                        <li>
                                            <a href="roompage.php">Room 4</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-third-level -->
                                </li>
								<li>
                                    <a href="#">Branch 2<span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="roompage.php">Room 1</a>
                                        </li>
