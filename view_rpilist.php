...
<body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12" >
				 ...
				 <h2 class="page-header">Latest Update</h2>
				<div id="asdf"></div>
				
				 <h1 class="page-header"><?php echo $_GET['roomName'];?>'s Raspberry Pi</h1>
				<div id="qwer"></div>
				<?php
	...
	<script>
		setInterval(function(){  
			...
			$('#asdf').load("view_latestupdatedata.php?roomID="+roomID);
	...
	<script>
		setInterval(function(){  
			var roomID = <?php echo $_GET['roomID'];?>;
			$('#qwer').load("view_data.php?roomID="+roomID);
