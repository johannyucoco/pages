...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo $_GET['branchname'];?> Branch</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
				<?php
					require_once('mysteryDB_connect.php');
						...
						$sql = "SELECT r.roomID as roomID, r.roomName as roomName, r.roomDescription as roomDescription, r.branchID as branchID
						...
						while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
							...
							echo 
								'
								<tr>
									<td class="text-center">'.$roomID.'</td>
									<td class="text-center"><a href="view_rpilist.php?roomID='.$roomID.'&roomName='.$roomName.'">'.$roomName.'</td>
