                            ...
                            <div class="row">
								...
								<?php
									...
									if (isset($_POST['submit'])){
										...
										if(!isset($message)){
											$query1="insert into rpi(rpiName,ipAddress,roomID) values ('$rpiName','$IPAddress','2')";
									...
									<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <input required name="rpiName" class="form-control" placeholder="Raspberry Pi Name">
                                        </div>
										<div class="form-group">
